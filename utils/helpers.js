...
//Object will contain info about anything we need to help app run
...
export function getMetricMetaInfo(metric) {
  ...
  return typeof metric === "undefined" ? info : info[metric];
  //If I invoke this method and dont pass anything (undefined - return info object otherwise return Info[metric])
}
